...
class Sessions
{
    ...
    /**
     * @ORM\Column(type="integer")
     * @Assert\LessThanOrEqual(propertyPath="nbMax", message="Le nombre de participants minimum doit être inférieur au nombre de participants maximum")
     */
    private $nbMin;
     ...
     * @Assert\LessThanOrEqual(propertyPath="dateEnd", message="La date de début doit être inférieure à la date de fin")
     */
    private $dateStart;
