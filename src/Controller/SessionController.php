...
class SessionController extends AbstractController
{
     ...
     */
    public function getAllSession(Sessions $session = null, Request $request, EntityManagerInterface $manager)
    {
     ...
     */
    public function getSessionModif(Sessions $session = null, Request $request, EntityManagerInterface $manager)
    {
     ...
     */
    public function delete(Sessions $session)
    {
    ...
    public function affichage()
    {
        ...
        // $session = $this->getDoctrine()->getRepository(Sessions::class)->findOneBy(array('user' => $idUser));
     ...
     */
    public function enleverSession(Request $request, EntityManagerInterface $manager, $id)
    {
